...
# Load drum sounds
sound_files = {
    "Crash Cymbal": "sounds/crash.mp3",
    "Ride Cymbal": "sounds/ride.mp3",
    "High Tom": "sounds/tom-1.mp3",
    "Mid Tom": "sounds/tom-2.mp3",
    "Hi-Hat": "sounds/hi-hat.mp3",
    "Floor Tom": "sounds/tom-3.mp3",
    "Snare": "sounds/snare.mp3",
    "Kick": "sounds/bass.mp3",
}

drum_sounds = {k: pygame.mixer.Sound(v) for k, v in sound_files.items()}
            ...
            for id, lm in enumerate(handLms.landmark):
                ...
                if id == 8:  # Index finger tip
                    ...
                    if zone and (now - last_hit[zone] > cooldown):
                        ...
                        print(hit_display)
                        if zone in drum_sounds:
                            drum_sounds[zone].play()
